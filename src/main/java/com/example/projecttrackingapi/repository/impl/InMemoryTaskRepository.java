...
public class InMemoryTaskRepository implements TaskRepository {
    ...
    static {
        TASKS.put(1L, new Task(1L, "Title #1", "Description #1...", 3, "High", "TODO", 1L));
        TASKS.put(2L, new Task(2L, "Title #2", "Description #2...", 13, "Low", "TODO", 1L));
        TASKS.put(3L, new Task(3L, "Title #3", "Description #3...", 5, "Medium", "IN_PROGRESS", 1L));
        TASKS.put(4L, new Task(4L, "Title #4", "Description #4...", 8, "High", "TODO", 2L));
